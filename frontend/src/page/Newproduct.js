    ...
    <div className="p-4">
       <form className='m-auto w-full max-w-md  shadow flex flex-col p-3 bg-white' onSubmit={handleSubmit}>
        ...
        <select className='bg-slate-200 p-1 my-1' id='category' name='category' onChange={handleOnChange} value={data.category}>
          ...
          <option value={"dress men"}>dress men</option>
          <option value={"dress women"}>dress women</option>
          <option value={"country foods"}>country foods</option>
          <option value={"glass"}>glass</option>
          <option value={"botiques"}>botiques</option>
          <option value={"rice"}>rice</option>
          <option value={"electronics"}>electrinics</option>
        </select>
